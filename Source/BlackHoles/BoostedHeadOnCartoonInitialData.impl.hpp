...
#if !defined(BOOSTEDHEADONCARTOONINITIALDATA_HPP_)
#error "This file should only be included through BoostedHeadOnCartoonInitialData.hpp"
#endif

#ifndef BOOSTEDHEADONCARTOONINITIALDATA_IMPL_HPP_
#define BOOSTEDHEADONCARTOONINITIALDATA_IMPL_HPP_
...
AMREX_FORCE_INLINE BoostedHeadOnCartoonInitialData::BoostedHeadOnCartoonInitialData(amrex::Real a_dx,
                                                            int a_initial_lapse)
...
BoostedHeadOnCartoonInitialData::compute_chi(Coordinates coords) const
{
...
BoostedHeadOnCartoonInitialData::compute_A(amrex::Real chi, Coordinates coords) const
{
        ...
        int ix, int iy, int iz, const amrex::Array4<amrex::Real> &state) const
{
    ...
    default:
        amrex::Abort(
            "BoostedHeadOnCartoonInitialData::Supplied initial lapse not supported.");
    }
}

#endif /* BOOSTEDHEADONCARTOONINITIALDATA_IMPL_HPP_ */
